...
import { 
  NosotrosPage, ServiciosPage, ProductosPage, CapacitacionesPage, 
  ProyectosPage, DescargasPage, BlogPage, ContactoPage 
      ...
      <AuthProvider>
        <BrowserRouter>
          <Routes>
            ...
            <Route path="/descargas" element={<PublicLayout><DescargasPage /></PublicLayout>} />
